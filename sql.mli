...
(** inserts a new forum *)
val new_forum : title:string -> descr:string -> moderated:bool -> int32
...
val new_thread_and_message :
  frm_id:int32 ->
  author:string -> subject:string -> txt:string -> int32 * int32
...
val new_wiki : title:string -> descr:string -> int32 
...
val wikipage_get_data : wik_id:int32 -> suffix:string ->
  (string * string * string * Calendar.t) option
