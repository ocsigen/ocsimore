...
static/ocsimore_client.uue: _build/wiki_client.cmo _build/forum/forum_client.cmo
	CAMLLIB=$(OBROWSERDIR) ocamlc -o ocsimore_client $(LWTDIR)/lwt_withoutunix.cma $(ELIOMOBROWSERDIR)/eliom_obrowser_client.cma _build/wiki_client.cmo _build/forum/forum_client.cmo
