(* OASIS_START *)
(* DO NOT EDIT (digest: 2a0c49af50e2ae73414db64a82926d5b) *)
(*
...
let setup_t =
  {
                     ...
                     },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage
                             ("ocaml-safepass",
                               Some (OASISVersion.VGreaterEqual "1.0"));
                           FindlibPackage
                             ("eliom.server",
                      ...
                      bs_data_files =
                        [
                           ...
                           ("../../INSTALL", None);
                           ("../../local/etc/ocsigen/ocsimore.conf", None)
                        ];
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\234@R\188'\1864\144\016\199\219\165L\194\130\217";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
