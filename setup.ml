(* OASIS_START *)
(* DO NOT EDIT (digest: 3fe2629250bc872bd7c3697ad8987e33) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          description = Some [OASISText.Para "A nice description"];
          categories = [];
            ...
            [
               Flag
                 ({
                  ...
                  },
                   {
                      flag_description =
                        Some
                          "Enable the support for external authentication using NIS";
               ...
               Flag
                 ({
                  ...
                  },
                   {
                      flag_description =
                        Some
                          "Enable the support for external authentication using PAM";
                      flag_default = [(OASISExpr.EBool true, false)]
                   });
               Flag
                 ({
                  ...
                  },
                   {
                      flag_description =
                        Some
                          "Enable the support for external authentication using LDAP";
                      flag_default = [(OASISExpr.EBool true, false)]
                   });
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage
                             ("macaque",
                               Some (OASISVersion.VGreaterEqual "0.6.1"));
                           FindlibPackage
                             ("safepass",
                               Some (OASISVersion.VGreaterEqual "1.2"));
                           FindlibPackage
                             ("eliom.server",
                               Some (OASISVersion.VGreaterEqual "3.0"));
                      ...
                      bs_data_files =
                        [
                           ("../files/createdb.sql", None);
                           ("../files/initdb.sh", None);
                           ("../../INSTALL", None);
                           ("../files/ocsimore.conf", None)
                        ];
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "src/user";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "ocsimore"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   {
                      lib_modules = ["User_data"; "User_external_auth"];
                      lib_pack = false;
                      lib_internal_modules = [];
               ...
               Library
                 ({
                  ...
                  },
                   {
                      bs_build =
                        [
                           ...
                           (OASISExpr.EFlag "nis", true)
                        ];
                      bs_install = [(OASISExpr.EBool true, true)];
                      bs_path = "src/user/nis";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "user"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   {
                      lib_modules = ["Nis_chkpwd"; "Ocsimore_nis"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "user";
                      lib_findlib_name = Some "nis";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "ocsimore-pam";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      bs_build =
                        [
                           (OASISExpr.EBool true, false);
                           (OASISExpr.EFlag "pam", true)
                        ];
                      bs_install = [(OASISExpr.EBool true, true)];
                      bs_path = "src/user/pam";
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [InternalLibrary "user"; FindlibPackage ("pam", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                   ...
                   {
                      lib_modules = ["Ocsimore_pam"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "user";
                      lib_findlib_name = Some "pam";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "ocsimore-ldap";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      bs_build =
                        [
                           (OASISExpr.EBool true, false);
                           (OASISExpr.EFlag "ldap", true)
                        ];
                      bs_install = [(OASISExpr.EBool true, true)];
                      bs_path = "src/user/ldap";
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [
                   ...
                   {
                      lib_modules = ["Ocsimore_ldap"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "user";
                      lib_findlib_name = Some "ldap";
                      lib_findlib_containers = []
                   });
               Library
                 ({
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "ocsimore_client";
                           FindlibPackage ("eliom.client", None);
                           FindlibPackage ("eliom.syntax", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "src/forum";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "wiki"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [InternalLibrary "ocsimore"; InternalLibrary "wiki"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_data_files =
                        [
                           ("../../../local/var/www/static/jquery.js",
                             Some "$datadir/$pkg_name/static")
                        ];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                      bs_cclib = [(OASISExpr.EBool true, [])];
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "src/site/client";
                      bs_compiled_object = Byte;
                      bs_build_depends = [InternalLibrary "core_site_client"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files =
                        [
                   ...
                   {exec_custom = false; exec_main_is = "ocsimore.ml"});
               Library
                 ({
                     cs_name = "user_site";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      ...
                      bs_path = "src/site";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "core_site"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [InternalLibrary "core_site"; InternalLibrary "forum"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_title = "API reference for Ocsimore";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\206\128\231_\189\128\138\007\226\211Oam2s\177";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
