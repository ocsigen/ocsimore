(* OASIS_START *)
(* DO NOT EDIT (digest: f36536d7c6d63bc4268658e4c41e4a4a) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_c_sources = [];
                      bs_data_files =
                        [("../../_build/src/site/client/ocsimore.js", None)];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                      bs_cclib = [(OASISExpr.EBool true, [])];
                      bs_dlllib = [(OASISExpr.EBool true, [])];
                      bs_dllpath = [(OASISExpr.EBool true, [])];
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\229\233K9\\\254\167\1948!S\238\173\189Yh";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
