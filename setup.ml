(* OASIS_START *)
(* DO NOT EDIT (digest: c6c6daab2fae4a94aea8886a4357b264) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_path = "src/user";
                      bs_compiled_object = Best;
                      bs_build_depends = [FindlibPackage ("pam", None)];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
               ...
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_path = "src/user";
                      bs_compiled_object = Best;
                      bs_build_depends = [FindlibPackage ("ldap", None)];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\182\170]'l\147\157&\245\190\199\190\004f\247\165";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
