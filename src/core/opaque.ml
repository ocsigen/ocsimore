...
let int32_input_xform ?a (i : 'a int32_t) :
    (HTML5_types.phrasing HTML5.M.elt, 'a int32_t) Xform.XformLwt.t =
...
let int32_input_opt_xform ?a : 'a int32_t option -> (HTML5_types.phrasing HTML5.M.elt, 'a int32_t option) Xform.XformLwt.t = function
