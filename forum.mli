...
val new_forum: Sql.db_t -> title:string -> descr:string -> moderated:bool -> arborescent:bool -> ?reader:Users.user -> ?writer:Users.user -> ?moderator:Users.user -> unit -> Sql.db_int_t Lwt.t
