       ...
       then
         (Lwt.catch
            (fun () ->
               ...
               Forum_data.new_message ~sp ~sd ~forum_id ~author_id:u
                 ?subject ?parent_id ~text >>= fun () ->
